...
const CORE = [
  ...
  '/data/fotos.json',
  '/assets/mapa.png',
  '/assets/menu/historia-bg.jpg',
  '/assets/menu/mapa-bg.jpg',
  '/assets/menu/logros-bg.jpg',
  '/assets/menu/talleres-bg.jpg',
  '/assets/menu/admision-bg.jpg',
